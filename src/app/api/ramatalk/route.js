...
export async function POST(request) {
  try {
    ...
    const { timeString, greeting, journalContext, mode } = context || {};
    ...
    switch (mode) {
      ...
      case 'doa':
        ...
        1. Selalu utamakan versi doa yang PALING FAMILIAR dan PALING UMUM dilafalkan oleh masyarakat Muslim Indonesia (mayoritas Mazhab Syafi'i).
          ...
          - Doa sehari-hari → (misal: niat wudhu, doa sebelum makan, doa keluar rumah)
          - Niat sholat fardhu → (misal: "Ushalli fardhadh dhuhri arba'a raka'atin mustaqbilal qiblati adaa'an lillaahi ta'aalaa")
          - Niat sholat sunnah → gunakan lafaz yang umum diajarkan di pesantren & masjid Indonesia (misal: Dhuha, Tahajud, Hajat)
      ...
      case 'surah':
        ...
        2. Jika user meminta TEMA atau TOPIK (misal: "ayat tentang sabar", "ayat tentang sedekah"):
      ...
      case 'fiqih':
        ...
        Tugasmu: Menjawab pertanyaan hukum Fiqih seputar ibadah sehari-hari, sholat, bersuci (thaharah), puasa sunnah, zakat/sedekah, dan muamalah untuk konteks Muslim Indonesia (mayoritas Mazhab Syafi'i).
      ...
      default:
        ...
        Tugasmu: Menjadi teman ngobrol, teman curhat, dan motivator Islami yang hangat dalam keseharian.
    ...
    // ─── System prompt ──────────────────────────────────────────────────────────
    const systemPrompt = `Kamu adalah asisten AI Islami yang beroperasi di dalam sebuah aplikasi, dirancang khusus sebagai sahabat Muslim Indonesia.

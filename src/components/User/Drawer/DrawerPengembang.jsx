...
const DrawerPengembang = ({ open, onClose }) => (
  ...
  >
    ...
    <p className='text-[13px] text-slate-600 dark:text-slate-300 leading-relaxed mb-6 bg-slate-50 dark:bg-slate-800/50 p-4 rounded-2xl border border-slate-100 dark:border-slate-700'>
      Aplikasi ini dikembangkan di waktu luang dengan tujuan membantu umat Muslim menjalankan ibadah di bulan suci Ramadhan agar lebih mudah dan bermakna.
      <br /><br/>
      Aplikasi ini merupakan hasil pengembangan dari karya sebelumnya yang dibuat oleh Rifky Muhammad Prayudhi.
    </p>
    ...
    <div className='flex items-center justify-center gap-3'>
      {[
        {
          href: 'https://github.com/Saiful-Bahri-95',
          icon: Github,
          hoverBg: 'hover:bg-[#1e3a8a]',
        },
        {
          href: 'https://www.linkedin.com/in/saiful-bahri47',

          icon: Linkedin,
          hoverBg: 'hover:bg-[#0077b5]',
        },
        {
          href: 'https://www.instagram.com/impal_ipul/',
          icon: Instagram,
          hoverBg: 'hover:bg-[#e1306c]',
        },
        {
          href: 'https://saiful-bahri.pro',
          icon: Mail,
